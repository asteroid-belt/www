    ...
    <div className="relative z-20 flex h-full items-center justify-center px-6 py-20">
      <div className="max-w-4xl space-y-6">
        ...
        <p className="text-lg text-gray-300">
          Shared context. Shared quality. Shared memory. Open source infrastructure for teams
...
const products = [
  {
    ...
    description:
      'Detect prompt injection, sync skill repositories, and install across 33 platforms.',
        ...
        {products.map((product) => (
          <div key={product.name} className="space-y-3 text-left">
            ...
            {'install' in product && product.install && (
              <code className="block text-sm text-gray-400">{product.install}</code>
            )}
